...
<body style="background-color:powderblue;">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        if (isset($_POST['cari'])) {
            $cari = $_POST['cari'];
            $query_product = mysqli_query($koneksi, "select * from product join merek on merek.id_merek=product.id_merek where product.id_product = '%$cari%' or product.nama_product like '%$cari%' or merek.nama_merek like '%$cari%'");
        }
        else{
